          ...
          {!business && !showCreateForm && (
            <div className="bg-white rounded-xl shadow-md p-8 text-center">
              ...
              <p className="text-gray-600 mb-6">
                Create your business profile to start building trust with customers
              </p>
              <button
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <div className="bg-white rounded-xl shadow-md p-6">
                  ...
                  <p className="text-3xl font-bold text-blue-600">{business.trustScore}/100</p>
                </div>

                <div className="bg-white rounded-xl shadow-md p-6">
                  <div className="text-3xl mb-2">👀</div>
                  <p className="text-sm text-gray-600">Profile Views</p>
                  <p className="text-3xl font-bold text-green-600">{business.profileViews}</p>
                </div>

                <div className="bg-white rounded-xl shadow-md p-6">
                  <div className="text-3xl mb-2">⭐</div>
                  <p className="text-sm text-gray-600">Total Reviews</p>
                  <p className="text-3xl font-bold text-yellow-600">{business.reviews.length}</p>
                </div>

                <div className="bg-white rounded-xl shadow-md p-6">
                  <div className="text-3xl mb-2">🚨</div>
                  <p className="text-sm text-gray-600">Total Reports</p>
                  <p className="text-3xl font-bold text-red-600">{business.reports.length}</p>
                </div>
              </div>
