  ...
  return (
    ...
    >
      <h3 className="text-xl font-bold text-red-800 mb-4">
        <AlertTriangle className="inline mr-2 text-red-600" size={20} />
        Report a Problem
      </h3>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 h-24 resize-none text-gray-900"
            required
          />
        </div>
